    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 px-3 py-2 rounded border border-[var(--md-border)] bg-[var(--md-bg-secondary)] text-[var(--md-text-primary)] focus:outline-none focus:border-[var(--md-accent-blue)]"
        />
        <button
